...
<div class="form-group">
									...
									<div class="col-md-6">
										<input type="text" class="form-control" name="tax_number" value="@if($order->direccion_factura){{  $order->direccion_factura->vat_number }} @endif"  id="tax_number" oninput='checkString(this.id)' required>
									</div>
								</div>
