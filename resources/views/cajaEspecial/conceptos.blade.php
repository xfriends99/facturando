...
<td><a href="/deleteConceptoCajaEspecial/{{$concepto->id}}" onClick="return confirm('¿Esta seguro?');" class="btn btn-danger">Eliminar</a></td>
</tr>
@endforeach
					...
					<form class="form-horizontal" role="form" method="POST" action="/conceptosCajaEspecial">
